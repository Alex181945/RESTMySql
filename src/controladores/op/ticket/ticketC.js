...
const TicketModelo = require(__basedir + "src/modelos/op/ticket/ticketM"),
  TicketControlador = () => {};
const AsignaTecnico = require(__basedir +
  "src/servicios/funciones/asignaTecnico");
...
TicketControlador.inserta = (req, res, next) => {
  ...
  /*Prueba de cambios archivo por archivo */
  /*Mas Pruebas */
  switch (req.body.iTipoAsignacionTecnico) {
    case "1":
      AsignaTecnico.cargaDeTrabajo(
        req.body.iTipoAsignacionTecnico,
        (error, filas) => {
          if (error) {
