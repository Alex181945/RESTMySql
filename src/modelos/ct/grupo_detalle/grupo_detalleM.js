...
GrupoDetalleModelo.todos = (data, callback) => {
...
GrupoDetalleModelo.listaAlumnos = (data, callback) => {
    ...
    sql += 'CALL consultaopGrupoAlumnos(@p0, @p1, @p2, @p3, @p4);';
...
GrupoDetalleModelo.uno = (data, callback) => {
    ...
    let sql = `SET @p0 = '${data.iTipoConsulta}'; `;
    sql  += `SET @p1 = '${data.iGrupo}'; `;
    sql += 'CALL opGrupoDetalleConsulta(@p0, @p1, @p2, @p3, @p4);';
    sql += 'SELECT @p2 AS `lError`, @p3 AS `cSqlState`, @p4 AS `cError`;';
...
GrupoDetalleModelo.inserta = (data, callback) => {
...
GrupoDetalleModelo.actualiza = (data, callback) => {
...
GrupoDetalleModelo.borra = (data, callback) => {
...
module.exports = GrupoDetalleModelo;